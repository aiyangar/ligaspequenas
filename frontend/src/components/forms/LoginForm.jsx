...
export const LoginForm = ({ onAuthSuccess, signIn }) => {
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="text-center">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="w-4/5 mx-auto pl-6 pr-4 h-10 border border-gray-300 rounded-full shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-center"
